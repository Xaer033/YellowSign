...
public class SyncCommander : TrueSyncBehaviour
{
    public class Factory : PlaceholderFactory<SyncCommander>, IValidatable
    {
        ...
        public override void Validate()
        {
            ...
            _container.Instantiate<SyncCommander>();
        }
    }
    ...
    public override void OnSyncedStart()
    {
        ...
        //_eventDispatcher.DispatchEvent(GameplayEventType.GAME_START);
